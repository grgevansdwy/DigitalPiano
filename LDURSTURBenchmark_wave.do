...
add wave -noupdate -childformat {{{/cpu_tb/dut/memory/mem[23]} -radix decimal} {{/cpu_tb/dut/memory/mem[22]} -radix decimal} {{/cpu_tb/dut/memory/mem[21]} -radix decimal} {{/cpu_tb/dut/memory/mem[20]} -radix decimal} {{/cpu_tb/dut/memory/mem[19]} -radix decimal} {{/cpu_tb/dut/memory/mem[18]} -radix decimal} {{/cpu_tb/dut/memory/mem[17]} -radix decimal} {{/cpu_tb/dut/memory/mem[16]} -radix decimal} {{/cpu_tb/dut/memory/mem[15]} -radix decimal} {{/cpu_tb/dut/memory/mem[14]} -radix decimal} {{/cpu_tb/dut/memory/mem[13]} -radix decimal} {{/cpu_tb/dut/memory/mem[12]} -radix decimal} {{/cpu_tb/dut/memory/mem[11]} -radix decimal} {{/cpu_tb/dut/memory/mem[10]} -radix decimal} {{/cpu_tb/dut/memory/mem[9]} -radix decimal} {{/cpu_tb/dut/memory/mem[8]} -radix decimal} {{/cpu_tb/dut/memory/mem[7]} -radix decimal} {{/cpu_tb/dut/memory/mem[6]} -radix decimal} {{/cpu_tb/dut/memory/mem[5]} -radix decimal} {{/cpu_tb/dut/memory/mem[4]} -radix decimal} {{/cpu_tb/dut/memory/mem[3]} -radix decimal} {{/cpu_tb/dut/memory/mem[2]} -radix decimal} {{/cpu_tb/dut/memory/mem[1]} -radix decimal} {{/cpu_tb/dut/memory/mem[0]} -radix decimal}} -expand -subitemconfig {{/cpu_tb/dut/memory/mem[23]} {-radix decimal} {/cpu_tb/dut/memory/mem[22]} {-radix decimal} {/cpu_tb/dut/memory/mem[21]} {-radix decimal} {/cpu_tb/dut/memory/mem[20]} {-radix decimal} {/cpu_tb/dut/memory/mem[19]} {-radix decimal} {/cpu_tb/dut/memory/mem[18]} {-radix decimal} {/cpu_tb/dut/memory/mem[17]} {-radix decimal} {/cpu_tb/dut/memory/mem[16]} {-radix decimal} {/cpu_tb/dut/memory/mem[15]} {-radix decimal} {/cpu_tb/dut/memory/mem[14]} {-radix decimal} {/cpu_tb/dut/memory/mem[13]} {-radix decimal} {/cpu_tb/dut/memory/mem[12]} {-radix decimal} {/cpu_tb/dut/memory/mem[11]} {-radix decimal} {/cpu_tb/dut/memory/mem[10]} {-radix decimal} {/cpu_tb/dut/memory/mem[9]} {-radix decimal} {/cpu_tb/dut/memory/mem[8]} {-radix decimal} {/cpu_tb/dut/memory/mem[7]} {-radix decimal} {/cpu_tb/dut/memory/mem[6]} {-radix decimal} {/cpu_tb/dut/memory/mem[5]} {-radix decimal} {/cpu_tb/dut/memory/mem[4]} {-radix decimal} {/cpu_tb/dut/memory/mem[3]} {-radix decimal} {/cpu_tb/dut/memory/mem[2]} {-radix decimal} {/cpu_tb/dut/memory/mem[1]} {-radix decimal} {/cpu_tb/dut/memory/mem[0]} {-radix decimal}} /cpu_tb/dut/memory/mem
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {58474511 ps} 0}
